...
// Source: internal/domain/repository/database_connection.go
...
func (m *MockClientDatabaseRepository) Ping(ctx context.Context) error {
	m.ctrl.T.Helper()
...
func (mr *MockClientDatabaseRepositoryMockRecorder) Ping(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Ping", reflect.TypeOf((*MockClientDatabaseRepository)(nil).Ping), ctx)
}
