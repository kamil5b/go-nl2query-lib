...
// Source: internal/domain/repository/vector_store.go
...
func (m *MockVectorStoreRepository) Search(ctx context.Context, tenantID string, queryEmbedding []float32, limit int) ([]model.Vector, error) {
	m.ctrl.T.Helper()
...
func (m *MockVectorStoreRepository) Upsert(ctx context.Context, tenantID string, vectors []model.Vector) error {
	m.ctrl.T.Helper()
